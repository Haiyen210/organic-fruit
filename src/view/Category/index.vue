            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing">
                    <div id="tableProgress" class="col-lg-12 col-12 layout-spacing">
                                            ...
                                            <tr v-for="item in category" :key="item.id">
                                                ...
                                                <td class="text-center">
                                                    <a href="javascript:void(0);" data-toggle="tooltip"
                                                        data-placement="top" title="" data-original-title="Edit" style="padding: 20px;" v-on:click="onEdit(item)"><svg
                                                        ...
                                                        </svg></a><a href="javascript:void(0);" data-toggle="tooltip" v-on:click.stop.prevent="onDelete(item)"
                        ...
                        <CategoryEdit :category="showEditStudent" v-if="isShowEdit == true" @ShowEditData="getEdit($event)" />
    ...
    methods: {
        ...
        onDelete(item) {
            if (confirm("Bạn có chắc muốn xóa danh mục số " + item.id)) {
                ...
                axios.post(`http://localhost:8080/Oganic_Fruit/rest/categoryService/deleteCategory/${item.id}`)
                    .then(response => {
